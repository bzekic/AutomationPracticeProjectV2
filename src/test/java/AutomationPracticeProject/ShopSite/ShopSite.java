...
public class ShopSite {
    ...
    private ShopOrderHistoryPage shopOrderHistoryPage;
    private ShopAddressConfirmationPage shopAddressConfirmationPage;
    private ShopShippingConfirmationPage shopShippingConfirmationPage;
    private ShopPaymentSelectionPage shopPaymentSelectionPage;
    private ShopBankWireTransferConfirmation shopBankWireTransferConfirmation;
    private ShopChequePaymentConfirmationPage shopChequePaymentConfirmationPage;
    private ShoppingCartPage shoppingCartPage;
    private ShopOrderConfirmationPage shopOrderConfirmationPage;
    private ShopMyAccountPage shopMyAccountPage;
